...
- **18 sep 2026** — Pedro mandó por error (era para otro chat) una captura
  de un Excel de su trabajo con "Archivo en uso" y pidió explicarlo en el
  manual; después pidió descartarlo. Quedó solo lo que sí es del blog,
  README 4b: no hay bloqueos (web + base); regla "un mismo post, una
