...
# --- bloque Embed y gráficos "video" ---------------------------------------
r = save({**GENERAL, "blocks": [
    {"type": "embed", "data": {"html": "<div id=\"x\">Hola <script>alert(1)</script></div>", "height": "300", "caption": "Hecho con IA"}},
...
bl = blocks()
ok(r.status_code == 200 and bl[0]["data"]["html"].startswith("<div") and bl[0]["data"]["height"] == 300
